          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="
                ...
                shadow-[0_0_25px_rgba(197,160,89,0.25)]
              ...
              ">
                ...
                <span className="
                  text-[#C5A059]
                  drop-shadow-[0_0_15px_rgba(197,160,89,0.5)]
                ">
                  PRO
                </span>
              </h1>
            ...
            <div className="flex items-center gap-2 mt-2 opacity-50">
              ...
              <span className="text-[9px] uppercase tracking-[0.35em] text-stone-400 font-black">
                Est. 2026
              </span>
              <div className="w-10 h-[1px] bg-[#C5A059]" />
            </div>
          ...
          <div className="flex gap-3">
            ...
            {SocialLinks.map((s) => (
              <a
                ...
                "
              >
                <span className="transition-transform duration-300 group-hover/icon:scale-125">
                  {s.svg}
                </span>
              </a>
            ))}
