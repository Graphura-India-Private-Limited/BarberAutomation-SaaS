          ...
          {NAV.map((n) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all text-left cursor-pointer group relative ${isActive
              ...
              {showProfileDropdown && (
                <>
                  ...
                  <div className="absolute right-0 mt-2 w-52 bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden z-50">
                    <div className="p-3.5 border-b border-gray-100 bg-gradient-to-r from-[#FFFFFF]to-[#F5F1ED]">
