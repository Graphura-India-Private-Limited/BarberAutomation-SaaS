...
export default function FinancePage() {
  ...
  // ── RESTRICTED ACCESS VIEW FALLBACK WITH FOOTER INTEGRATION ──
  ...
  return (
    /* ✅ Structural flex layout holds the footer neatly at the baseline edge */
    <div className="min-h-screen font-sans text-zinc-800 flex flex-col justify-between" style={{ background: "var(--bg)" }}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@300;400;500;600;700;800&family=Playfair+Display:ital,wght@0,400..900;1,400..900&display=swap');
        :root { 
      ...
      <div>
        ...
        <main className="max-w-5xl mx-auto px-4 pb-12 pt-8 sm:px-8">
          <p className="text-amber-700 font-sans font-bold tracking-[2px] text-xs sm:text-sm uppercase mb-1 text-left">
            Salon Financial Administration
          </p>
          <h2 className="text-3xl sm:text-4xl font-bold text-zinc-900 font-serif tracking-normal mb-1 text-left">Finance Overview</h2>
          <p className="text-sm text-zinc-500 font-sans normal-case mb-6 text-left">
      ...
      {/* ── ✅ THE PIECE INJECTION: Renders your custom footer here natively at the absolute base ── */}
      <Footer />
