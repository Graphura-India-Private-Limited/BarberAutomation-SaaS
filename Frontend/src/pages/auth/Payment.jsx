...
import { CreditCard, Shield, CheckCircle2, AlertCircle, Scissors } from 'lucide-react';
...
// Premium background salon image asset to anchor the left side preview framework
...
export default function Payment() {
  ...
  return (
    <div className="flex min-h-screen font-sans antialiased text-stone-800" style={{ background: "#FAF6F0" }}>
      ...
      {/* ── LEFT SIDE: DYNAMIC LIFESTYLE HERO IMAGE FRAME ── */}
      <div className="relative hidden md:flex flex-col justify-end w-[48%] overflow-hidden min-h-screen">
        ...
        {/* Ambient bottom brand narrative placement block */}
      ...
      {/* ── RIGHT SIDE: THEMED VERIFICATION CHECKOUT HUB ── */}
      <div className="flex flex-1 items-center justify-center px-6 py-12 sm:px-12" style={{ backgroundColor: "#F2EBE0" }}>
        ...
        <div className="w-full max-w-md card p-8 sm:p-10 text-stone-800 text-left animate-in fade-in slide-in-from-right-8 duration-500">
          ...
          <div className="mb-5">
            ...
            <p className="text-xs font-medium text-stone-400 mt-1">Confirm your premium account tier membership subscription parameters purchase.</p>
          </div>
          ...
          {/* Parameter Metrics Breakdown Ledger Box */}
          ...
          {/* Dynamic Intercept State Response Alerts */}
          {state === 1 && (
          ...
          {/* Interactive Core Action Triggers */}
