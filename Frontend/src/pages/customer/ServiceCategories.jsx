...
const CATEGORIES = [
  {
    ...
    accent: "#C5A059",
    stats: [
      { label: "Cuts & Styling", val: "10+" },
      { label: "Beard Artistry", val: "10+" },
      { label: "Spa & Colour", val: "20+" },
    ],
  },
  {
    id: "women",
    ...
    accent: "#D4A0B0",
    stats: [
      { label: "Cuts & Blowouts", val: "10+" },
      { label: "Colour Rituals", val: "10+" },
      { label: "Spa & Treatments", val: "20+" },
    ],
  },
  {
    id: "addon",
    ...
    accent: "#7BBFA5",
    stats: [
      { label: "Massages", val: "10+" },
      { label: "Treatments", val: "10+" },
      { label: "Colour Boosts", val: "10+" },
    ],
  },
];
