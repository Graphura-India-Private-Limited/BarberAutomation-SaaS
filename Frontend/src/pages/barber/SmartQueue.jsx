    ...
    >
      ...
      <div className="flex-1 min-w-0 text-left">
        <div className="flex items-center gap-2 flex-wrap mb-1">
          ...
          {isFirst && (
            <Chip color={entry.status === 'in-progress' ? '#10B981' : '#C5A059'}>
      ...
      {isFirst && (
        <button
          ...
          className="bg-[#3E362E] hover:bg-[#2A241F] text-white font-black text-[10px] uppercase tracking-widest px-4 py-2.5 rounded-xl transition-all shadow-xs cursor-pointer hover:scale-105 active:scale-95 shrink-0"
        >
