    ...
    <div className="min-h-screen font-sans text-stone-800 selection:bg-amber-100" style={{ background: "#FAF6F0" }}>
      ...
      <header className="w-full border-b border-[#3E362E] bg-[#251F1B] sticky top-0 z-40 px-6 py-4 flex items-center justify-between shadow-md">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h4 className="font-sans font-black uppercase tracking-widest text-[11px] text-white">Barber Pro</h4>
            <p className="font-sans text-[9px] font-extrabold uppercase tracking-widest text-[#C5A059] mt-0.5">Admin Management</p>
          </div>
        </div>
        <div className="flex items-center gap-6">
          <div className="hidden sm:flex flex-col text-right">
            ...
            <span className="font-sans text-xs font-extrabold uppercase tracking-wider text-[#FFE6A7] mt-0.5">{time} IST</span>
          </div>
      ...
      <main className="max-w-6xl mx-auto px-4 py-10 md:px-8">
        ...
        <header className="mb-10 rounded-3xl p-8 card relative overflow-hidden bg-white">
          <div className="relative z-10">
            ...
            <p className="font-sans text-sm font-normal leading-relaxed text-stone-600 mt-3">Monitor platform registration nodes, alter salon provision bounds, and inspect user directory states.</p>
          </div>
                      ...
                      {data.barbers?.length === 0 ? (
                        ...
                        data.barbers?.map((barber) => (
                          <tr key={barber._id} className="hover:bg-stone-50/50 transition-colors">
                            ...
                            {/* <td className="py-4 font-mono font-sans text-xs font-extrabold uppercase tracking-wider text-amber-700">{barber.salon_id || "Unassigned Anchor"}</td> */}
                      ...
                      {data.customers?.length === 0 ? (
                        ...
                        data.customers?.map((cust) => (
                          <tr key={cust._id} className="hover:bg-stone-50/50 transition-colors">
                            ...
                            {/* <td className="py-4 font-mono font-sans text-xs font-extrabold uppercase tracking-wider text-stone-700">{cust.phone || "No wire token"}</td> */}
